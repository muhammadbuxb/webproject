...
<li id="menu-item-462" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-462"><a title="Contact" class="123" href="./cart_pizza.php">cart</a></li>
</ul>
					</nav>
        ...
        $('#cart').click(
            ...
            function(){
              var id =   $('#product_id').text();
                ...
                var list_of_cart = sessionStorage.getItem("add");
                if(list_of_cart){
                    var item = {"id":id,"name":name,"price":price,"quantity":quantity};
                    list_of_cart = JSON.parse(list_of_cart);
                    list_of_cart.push(item);
                    //console.log(list_of_cart);
                    sessionStorage.setItem("add",JSON.stringify(list_of_cart));
                }else{
                    list_of_cart = [];
                    var item = {"id":id,"name":name,"price":price,"quantity":quantity};
                    list_of_cart.push(item);
			...
			<div class="col-xl-5 col-lg-6">
		        <div class="product-details-img mb-20">
		            <div class="tab-content" id="myTabContent3">
                                ...
                                <div class="product-medium-img">
                                    <img width="370" height="315" src="<?=$row['image_path']?>" class="attachment-1000 size-300" alt=""  sizes="(max-width: 370px) 100vw, 470px">                                </div>
                            </div>
			                    ...
			                    <div class="product-medium-img">
			                        <img width="370" height="315" src="<?=$row['image_path']?>" class="attachment-1000 size-300" alt=""  sizes="(max-width: 370px) 100vw, 370px">			                    </div>
			                </div>
		            ...
		            <ul class="nav" id="myTab2" role="tablist">
		            			            			                <li class="nav-item">
		                    <a class="nav-link active 0" id="home-tab" data-toggle="tab" href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#home" role="tab" aria-selected="true">
		                        <img width="570" height="515" src="image/creemy.png" class="attachment-1000 size-1000" alt="" sizes="(max-width: 570px) 100vw, 570px"> 
							</a>
		                </li>
		                								            			                <li class="nav-item">
		                    <a class="nav-link" id="profile-tab1" data-toggle="tab" href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#profile1" role="tab" aria-selected="false">
		                        <img width="570" height="515" src="image/creemy.png" class="attachment-1000 size-1000" alt=""  sizes="(max-width: 570px) 100vw, 570px"></a>
		                </li>
														            			                <li class="nav-item">
		                    <a class="nav-link" id="profile-tab2" data-toggle="tab" href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#profile2" role="tab" aria-selected="false">
		                        <img width="570" height="515" src="image/creemy.png" class="attachment-1000 size-1000" alt="" sizes="(max-width: 570px) 100vw, 570px"></a>
		                </li>
														            </ul>
		        </div> -->
 			...
 			<div class="col-xl-6 col-lg-6">
                <div class="product-details mb-30">
					<p hidden id="product_id"><?=$row['id']?></p>
                    <div class="post-title "><h3 class="post-title" id="title"><?=$row['product_name']?></h3></div><div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">

	<p class="price"> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">PKR</span><h5 id="product_price"><?=$row['product_price']?></h5></span></ins></p>
...
<div class="product_meta">	
		<span class="sku_wrapper">Quantity <span class="sku" itemprop="sku"> <input type="number" id="quantity" value="1" style="width:60px; margin-left:30px;"></span></span>

</div>

	 	<button  type="submit"  id="cart" class="btn btn-primary site-button pull-left" style="margin-top:60px;"><i class="fa fa-cart-plus"></i> Add to cart</button>
	...
	<div class="panel-heading">
		<ul class="nav nav-tabs">
					...
					<a href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#tab-description" data-toggle="tab">Description</a>
				</li>
							<li class=" additional_information_tab">
					<a href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#tab-additional_information" data-toggle="tab">Additional Information</a>
				</li>
							<li class=" reviews_tab">
					<a href="https://shtheme.com/demosd/orgafe/?product=fresh-orange#tab-reviews" data-toggle="tab">Reviews (1)</a>
				</li>
								</ul>
		</div>
...
<div>
	<meta itemprop="url" content="https://shtheme.com/demosd/orgafe/?product=fresh-orange">
